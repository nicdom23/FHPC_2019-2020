...
#PBS -N sched_scalability_on_mandelbrot_scheduling_lower_N
#PBS -l walltime=01:00:00
#PBS -q devel
cd $HOME/workspace_assignment_3/FHPC_2019-2020/Workspace_3
Var=results/time_execution_weak_mandelbrot_scheduling_no_collapse.csv
...
rm $Var
 ...
 N=$(($M*$procs))
 	...
 	for (( i=0; i<=$NSHOTS; i=i+1 )) 
		...
		realtime=$( /usr/bin/time -f "buuuh %E" ./parallel_mandelbrot_scheduling $N $N -2 -2 2 2 100 2>&1 | grep buuuh | cut -d' ' -f2) 
