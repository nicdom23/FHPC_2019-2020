...
plot(strong_scalability_elapsed_time_openmp$p,strong_scalability_elapsed_time_openmp$time,ylab="time", xlab="p", col="blue",type="l",main="strong scalability execution times")


lines(strong_scalability_walltime_openmp$p,strong_scalability_walltime_openmp$time,col="red",type="l",main="strong scalability walltime openmp")
lines(p_mpi_strongscaling,times_walltimes_mpi,type="l",col="green",main="strong scaling execution times mpi_pi")
lines(strong_scaling_elapsed_time_mpi$p,strong_scaling_elapsed_time_mpi$time,col="violet",type="l",main="strong scaling elapsed times mpi")

legend(14, 20, legend = c("openmp walltime","openmp elapsed time","mpi_pi walltime","mpi_pi elapsed_time"), fill = c("red","blue","green","violet"), col="red", bg ="white")
