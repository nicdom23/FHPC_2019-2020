...
//the two for cycles explore the whole matrix to fill its cells with the wanted numbers
#pragma omp for nowait
	...
	{	  
		...
		//test if the complex number c_r+i*c_i belongs to the Mandelbrot set	
